...
class prematriculaControler{
	...
	//$Codprematricula=$Array['Codprematricula'];
		$NomeCompleto=addslashes($Array['NomeCompleto']);
		$Email=addslashes($Array['Email']);
		$Telefone=$Array['Telefone'];
		$Whatsapp=$Array['Whatsapp'];
		$NivelIngles=addslashes($Array['NivelIngles']);
		$ComoConheceu=addslashes($Array['ComoConheceu']);
		$ContePouco=addslashes($Array['ContePouco']);
		$CPF=$Array['CPF'];
		$Status="1";
    ...
    public static function UpdateprematriculaDB($pdo,$Array){
		...
		$NomeCompleto=addslashes($Array['NomeCompleto']);
		$Email=addslashes($Array['Email']);
		$Telefone=addslashes($Array['Telefone']);
		$Whatsapp=addslashes($Array['Whatsapp']);
		$NivelIngles=addslashes($Array['NivelIngles']);
		$ComoConheceu=addslashes($Array['ComoConheceu']);
		$ContePouco=addslashes($Array['ContePouco']);
		$CPF=addslashes($Array['CPF']);
		$Status=$Array['Status'];
		$datacriado=$Array['datacriado'];
