...
//$localURL = "https://yesweteach.com.br/";
...
<html>
    <head>
        ...
        <meta name="author" content="<?php echo $AutorSite; ?>">
        ...
        <link rel="shortcut icon" href="<?php echo $localURL.$favico; ?>">
        
        <meta property="og:locale" content="PT_br">
	<meta property="og:type" content="website">
	<meta property="og:title" content="<?php echo $TituloBase; ?>">
	<meta property="og:description" content="<?php echo $DescricaoBase; ?>">
	<meta property="og:url" content="<?php echo $localURL; ?>">
	<meta property="og:site_name" content="<?php echo $TituloBase; ?>">
	<meta property="og:image" itemprop="image" content="<?php echo $localURL.$favico; ?>">
		...
		<header>
			...
			<div class="container">
				<a class="navbar-brand" href="Inicio"><div class="logo">
					<!--<img src="imgs/semfundoImagenGaleria.png" alt="<?php echo $AutorSite; ?>" style="width: auto;background: #f2ebc4; background:white; border-radius: 100%;">-->
					<img src="<?php echo $LogoMarcaDesktop; ?>" alt="<?php echo $AutorSite; ?>" style="width: 100px; height: 130px; margin-left: 0px;margin-top: -20px;">
				</div></a>
