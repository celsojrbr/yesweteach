		...
		<div class="container">
			<div class="row" style="margin-right:0px; margin-left:0px;">
				...
				<div class="col-md-12" style="background: #f2b705; color:#000; margin-bottom: 15px;margin-top: -70px;z-index: 2;">
					<h1 style="font-size: 36px;font-weight: bold;text-align: center; padding: 30px;">Desbrave o seu futuro agora mesmo: domine o inglês e desbloqueie oportunidades para vivências extraordinárias</h1>
				</div>
				
				<div class="col-md-4" style="background: #f2b705; color:#000; display: flex; align-items: center">
					<h1 style="font-size: 30px; padding: 30px;">Muito além de <b>aulas de inglês tradicionais: soluções de alta performance no aprendizado da língua são a especialidade</b> da Yes, we teach!</h1>
				</div>
				
				<div class="col-md-4" >
					<div class="" style="background: #f2b705; color:#000;align-items: center;display: flex;">
						<h1 style="font-size: 25px; padding: 30px;"><b>Aprenda de onde estiver! Nossas aulas são 100% online</b>, permitindo que você tenha liberdade geográfica pra aprender inglês!</h1>
					</div>
					<br/>
					<div class="" style="background: #f2b705; color:#000;align-items: center;display: flex;">
						<h1 style="font-size: 25px; padding: 30px;">Você nunca é visto como um número: <b>Na Yes, we teach! os alunos são analisados individualmente,</b> independendo se são parte da consultoria individual ou em grupos.</h1>
					</div>
				</div>
				
				<div class="col-md-4" style="background: #f2b705; color:#000;align-items: center;display: flex;">
					<h1 style="font-size: 28px; padding: 30px;">Respeitamos a pluralidade e individualidade de cada aluno, norteando todos os processos da escola, principalmente no início, <b>quando em uma entrevista inicial consideramos seus interesses e objetivos pra indicarmos a melhor solução!</b></h1>
				</div>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				<div class="col-lg-6 no-padding about-left" style="padding-left:0px;">
					...
					<img src="<?php echo $localURL; ?>imgs/semfundoImagenGaleria.png" class="img-fluid" alt="Sté e Bia Sócias fundadoras da Yes, we teach!" style="background:url('<?php echo $localURL; ?>imgs/yesweteach.jpg');background-size: cover; background-position: center;height: 470px;width: 100%;">
				</div>
							...
							<table style='width:100%; background:#fff' align='center' cellpadding='0' cellspacing='0'>
								...
								<tr>	
									<td align='center' style='background:#f2b705; color:#fff; font-size:16px;'>
										...
										<br/>
										<p id='TextNormalizado' >
											<h1><a href='https://api.whatsapp.com/send/?phone=55$Whatsapplink' target='_blank'><button class='btn btn-primary' type='button' style='font-size: 0.75em;'>Entre em contado pra agilizar o precesso</button></a></h1>
										</p>
									</td>
								</tr>
								<tr>	
	...
	<section id="video-container">
            ...
            <div class="container">
                <div class="contact-content">
                    <div class="row">
                    <h2 class="text-center" style="Color:#fff;font-size:48px;text-decoration-color: #f2b705;text-decoration: underline;text-decoration-color: #f2b705;">Feed do nosso Instagram</h2>
										...
										<br/>
											<ul class="social-icons">
												<li>
													...
													<a href="https://api.whatsapp.com/send/?phone=55<?php echo $Whatsapp; ?>" target="_blank" style="width: 50px; height: 50px; line-height: 65px;"><i class="fa fa-whatsapp" style="font-size: 30px;"></i></a>
